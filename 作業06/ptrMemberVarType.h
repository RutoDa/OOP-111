#ifndef PTRMEMBERVARTYPE
#define PTRMEMBERVARTYPE
...
public:
    ...
    void insertAt(int index, int num);
      //Function to insert number into the array p at the
      ...
      //of the last item in the list, number is added at the end
      //of the list.
